...
class AdminHealth {
	...
	public function test_extensions_support() {
		...
		$description_text = __( 'Knit Pay uses extensions to integrate with form, booking and other e-commerce plugins. All extensions support the currently activated plugin versions.', 'pronamic_ideal' );
