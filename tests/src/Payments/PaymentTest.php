...
class PaymentTest extends TestCase {
	...
	public function get_and_set_provider() {
		...
		return [
			...
			[ 'set_total_amount', 'get_total_amount', new TaxedMoney( 89.95, 'INR' ) ],
			[ 'set_shipping_address', 'get_shipping_address', new Address() ],
			[ 'set_shipping_amount', 'get_shipping_amount', new Money( 10, 'INR' ) ],
	...
	public function test_json() {
		...
		$line->set_total_amount( new Money( 39.99, 'INR' ) );
